...
<body>
	...
	<div class="card">
		...
		<?php
		  $mensaje="";
		  $nit=$data['ente']['nit'];
		  $razonsocial=$data['ente']['razonsocial'];
		  $representanteLegal=$data['ente']['representanteLegal'];
		  $correoElectronico=$data['ente']['correoElectronico'];
		  $telefono=$data['ente']['telefono'];
		  $web=$data['ente']['web'];
		  $ciudad=$data['ente']['ciudad'];
		  $capacidad=$data['ente']['capacidad'];
