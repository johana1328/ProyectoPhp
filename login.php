...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="Portal/public/css/style1.css">
				...
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
							...
							<a href="index.html" class="btn btn-white btn-outline-white">RVC</a>
								<h2>Bienvenido!</h2>
					...
					<form action="Portal/controlsesion.php" class="signin-form" method="POST">
  ...
  <script src="Portal/public/js/popper.js"></script>
